...
<body>
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner border">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="../../public/uploads/admin.jpg" alt="Image">
                        </div>
    ...
    <script src="../../public/pages/lib/easing/easing.min.js"></script>
    <script src="../../public/pages/lib/owlcarousel/owl.carousel.min.js"></script>
