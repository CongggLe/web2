...
<body>
    <?php
        ...
        if(isset($_POST['add'])){
            ...
            if ($dbCon -> query("INSERT INTO tbl_order (customer_name,customer_email,customer_phone,customer_address,order_status,order_total,order_date) VALUES (N'$hoten',N'$email',N'$phone',N'$address','$order_status','$order_total',N'$order_date')")){
                echo"<script> alert('Thêm thành công');</script>";
                $order_id = $dbCon -> query("SELECT order_id FROM tbl_order ORDER BY order_id DESC");
                $order_id_conv = $order_id->fetch(PDO::FETCH_ASSOC);
                $order_id_get = $order_id_conv['order_id'];
                echo"$order_id_get";
                die;

                // $dbCon -> query("INSERT INTO tbl_order_detail (order_id,product_id,product_name,product_price_sale,product_sale_qty) VALUES ($order_id,3,'Gạo Bến Nước','25000',5)"); 
            } 
        ...
        <div class="row px-xl-5">
            <div class="col-lg-8 table-responsive mb-5">
                <form method="POST" action="">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="row">
                                    <div class="col-md-6 form-group">
                                        <label>Họ & Tên</label>
                                        <input name="customer_name" class="form-control" type="text" placeholder="John">
                                    </div>
                                    <div class="col-md-6 form-group">
                                        <label>E-mail</label>
                                    ...
                                    <div class="col-md-6 form-group">
                                        <label>Địa chỉ</label>
                                        <input name="customer_address" class="form-control" type="text"
                    ...
                    <button type="submit" name="add" class="btn btn-block btn-primary my-3 py-3">Checkout</button>
                </form>
            </div>
